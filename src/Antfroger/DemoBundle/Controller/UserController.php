...
use Antfroger\DemoBundle\Entity\User;
...
class UserController extends Controller
{
    ...
    public function showAction(User $user)
    {
        ...
        $user = $this->getDoctrine()
            ->getRepository('AntfrogerDemoBundle:User')
        ...
        return $this->render(
            'AntfrogerDemoBundle:User:show.html.twig',
            array('user' => $user)
        );
    }
    ...
    public function createAction($username)
    {
        ...
        return $this->forward('AntfrogerDemoBundle:User:show', array('username' => $user->getUsername()));
    }
