...
namespace Antfroger\DemoBundle\Entity;
...
/**
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="Antfroger\DemoBundle\Entity\UserRepository")
...
class User implements AdvancedUserInterface, Serializable
{
     ...
     * Add roles
     *
     * @param \Antfroger\DemoBundle\Entity\Role $roles
     * @return User
     */
    public function addRole(\Antfroger\DemoBundle\Entity\Role $roles)
    {
        $this->roles[] = $roles;
     ...
     * @param \Antfroger\DemoBundle\Entity\Role $roles
     */
    public function removeRole(\Antfroger\DemoBundle\Entity\Role $roles)
    {
